...
export function FinalCtaSection() {
  return (
    <section className="px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
      <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-primary px-6 py-14 text-center sm:px-12 sm:py-20">
        ...
        <div className="relative">
          <FadeIn>
            <h2 className="font-display mx-auto max-w-2xl text-2xl font-medium leading-tight tracking-tight text-white sm:text-4xl">
