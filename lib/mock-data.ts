...
export const pricingPlans = [
  {
    ...
    description: "Try the full workspace before you commit — no card required.",
    features: [
  ...
  },
  {
    ...
    priceLabel: "$19",
    period: "/month",
    description: "Every tool a product business needs to go from raw photo to ready-to-list, in one plan.",
    features: [
      ...
      "Shopify, Slack & QuickBooks integrations",
  ...
  },
  {
    ...
    priceLabel: "Custom",
    period: "contact us",
    description: "For agencies and multi-brand teams that need custom limits, support, and security.",
    features: [
      "Everything in Pro, plus:",
      "Unlimited team seats",
      "Custom readiness rules & SLAs",
      "Single sign-on (SSO)",
      "Dedicated onboarding & support",
      "Custom integrations & API limits",
    ],
    highlighted: false,
    cta: { label: "Contact support", href: "mailto:support@creativelycomm.com" },
  },
];
