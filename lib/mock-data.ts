...
export const pricingPlans = [
  {
    ...
    price: 19,
    description: "Core software platform with every tool a product business needs — hardware systems are optional add-ons",
    features: [
      ...
      "Optional: Capture Dock hardware integration",
      "Optional: Scan Station & POS Reader hardware",
      "Optional: QC Camera & Content Kit systems",
    ],
    highlighted: true,
  },
];
