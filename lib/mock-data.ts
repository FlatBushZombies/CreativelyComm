...
export const pricingPlans = [
  {
    ...
    price: 19,
    description: "One dashboard, every tool a product needs — no plugins, no hidden costs",
    features: [
      "Inventory management & low-stock alerts",
      "Barcode scanner & receipt printing (POS)",
      "Order automation",
      ...
      "Multi-channel export (Shopify, Amazon, Etsy & more)",
      "Team collaboration",
      "API access",
    ],
    highlighted: true,
